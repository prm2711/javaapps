...
<body>
	...
	<form method="post" action="<c:url value = "/InsertPlayerServlet"/>"
		...
		<br> <input type="text" name="country" id="country"
			placeholder="Country" /><br> <input type="text"
			name="origpoints" id="origpoints" placeholder="Original Points" /><br>
		<input type="text" name="newpoints" id="newpoints"
			placeholder="New Points" /><br> <input type="text"
			name="numbermatch" id="numbermatch" placeholder="Number of Matches" /><br>
